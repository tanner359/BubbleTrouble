...
public class Enemy : MonoBehaviour
{
    ...
    public Vector2 Bottom_L { get; private set; }
    public Vector2 Top_L { get; private set; }
    public Vector2 Bottom_R { get; private set; }
    public Vector2 Top_R { get; private set; }
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(Bottom_L, Bottom_R);
        Gizmos.DrawLine(Bottom_R, Top_R);
        Gizmos.DrawLine(Top_R, Top_L);
        Gizmos.DrawLine(Bottom_L, Top_L);
    }
